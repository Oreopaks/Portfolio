...
_KIND = {"чехол", "чехлы", "геймпад", "станция", "колонка", "часы", "watch",
         ...
         # PS/гейминг: игра (код ppsa/cusa) != консоль != наушники Pulse. Все делят
         # токен «playstation 5», из-за чего игра за 2990 ложно липла к консоли за
         # 53990 (fuzzy 58). Консоль↔консоль сохраняется (у обоих kind пуст).
         "ppsa", "cusa", "pulse"}
